...
constexpr int RELATIVE_COORDINATE_NUM = 2;	// 玉を中心とした相対座標
constexpr u32 MAX_FEATURES1_NUM = PIECETYPE_NUM/*駒の配置*/ + PIECETYPE_NUM/*駒の利き*/ + MAX_ATTACK_NUM/*利き数*/ + RELATIVE_COORDINATE_NUM/*相対座標*/;
